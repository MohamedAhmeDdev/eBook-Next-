   ...
   <div className='container-xxxl'>
      <div className='row justify-content-center align-items-center my-5'>
        ...
        <div className='col-md-5 border'>
         ...
         <div className='col-md-4 border border-warning d-block'>
             <div class="container card text-center info border border-top-0">
             <div className="card-header">Description</div>
                <div class="row">
                  <div class="col">{user.BookDescription}</div>
                </div>
             </div>
            ...
            <div className="d-flex align-items-center justify-content-center">
              <div className="card list-card border border-end-0 my-2">
                ...
                <div className="card list-card border my-2">
                    ...
                    <ul className="list-group list-group-flush">
                        <li className="list-group-item border border-top-0 border-bottom-0">{user.bookName}</li>
                        <li className="list-group-item border border-top-0 border-bottom-0">{user.BookAuthor}</li>
